...
17) change directory to pre-trained_models:(cnn_traffic) E:\traffic_classification> cd pre-trained_models

18)run the python scipt: (cnn_traffic) E:\traffic_classification\pre-trained_models>python train_cnn.py -m model1.h5

18)run the python scipt: (cnn_traffic) E:\traffic_classification\pre-trained_models>python train_cnn.py -m model2.h5
